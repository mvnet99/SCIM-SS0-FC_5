using System;
using WS.FC.Dapper.Shared.Commands.Core;
using WS.FC.Dapper.Shared.DTOs.Pewo;

namespace WS.FC.Dapper.Shared.Commands.Pewo;

public class CreateWorkflowRunCommand : BaseCommandWithResponse<int>
{
...
public class CreateWorkflowRunEventCommand : BaseCommandWithResponse<int>
{
...
public class UpsertStepRunCommand : BaseCommand
{
    public int Id_WorkflowRun { get; set; }
...
public class SetRunTerminalStatusCommand : BaseCommand
{
    public int Id_WorkflowRun { get; set; }
    public string Status { get; set; } = string.Empty;
...
public class AdvanceScheduleCommand : BaseCommand
{
    public int Id_Schedule { get; set; }
...
public class ResetRunForRetryCommand : BaseCommand
{
    public int Id_WorkflowRun { get; set; }
}

public class InsertLogCommand : BaseCommand
{
    public int Id_WorkflowRun { get; set; }
    public int? Id_Customer { get; set; }
...
public class CreateRunOnEventCloseCommand : BaseCommandWithResponse<List<EventCloseResponseDto>>
{
    public int Id_Customer { get; set; }
    public int Id_Event { get; set; }
